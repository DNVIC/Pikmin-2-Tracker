...
function changeImage1() {
        ...
        {
            document.getElementById("orange").src = "http://www.userinterfaceicons.com/80x80/maximize.png";
        }
        else 
        {
...
function changeImage2() {
        ...
        {
            document.getElementById("can").src = "http://www.userinterfaceicons.com/80x80/maximize.png";
        }
        else 
        {
